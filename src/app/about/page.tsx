    ...
    <main className="min-h-screen pt-32 pb-24 bg-transparent border-t border-[var(--color-text)]/10">
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-20 border-b border-[var(--color-text)]/10 pb-12">
          <p className="font-mono text-[var(--color-text)]/40 tracking-[0.2em] uppercase text-xs mb-6">Our Story</p>
          <h1 className="font-display text-5xl md:text-6xl lg:text-7xl text-[var(--color-text)] tracking-tight mb-8">Born in Bali.<br />Brewed in Mumbai.</h1>
        </div>

        <div className="prose prose-lg mx-auto font-body text-[var(--color-text)]/80 leading-relaxed font-light space-y-8">
          <p className="text-xl text-[var(--color-text)] font-normal tracking-tight">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-[var(--color-text)] mt-16 mb-8 tracking-tight">The 100% Non-Alcoholic Cafe</h2>
          <p>
          ...
          <h2 className="font-display text-3xl md:text-4xl text-[var(--color-text)] mt-16 mb-8 tracking-tight">Global Flavours, Local Heart</h2>
          <p>
